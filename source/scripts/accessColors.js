...
/**
 * Function to toggle the accessibility colors
...
function toggleColors () {
  if (!accessibleMode) {
    ...
    root.style.setProperty('--pink-grad', 'linear-gradient(0deg, #744E4F 0%, #585858 100%)');
    ...
    root.style.setProperty('--green-grad', 'linear-gradient(180deg,  #57575700 0%, #00644e 100%)');
    ...
    root.style.setProperty('--pink-grad', 'linear-gradient(0deg, #FFD1D1 0%, #EEEEEE 100%)');
    ...
    root.style.setProperty('--green-grad-1', 'linear-gradient(180deg, #0D927A 0%, #ffffff00 100%)');
  }
