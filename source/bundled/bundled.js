...
const enUS = {
    ...
    interruption2: 'End this pomo session? <br> This will not count as an interruption.',
    yes: 'Yes',
    no: 'No',
    ...
    bestDay: 'Best Day:',
    bestDayUnits: '<span id="total-best-pomo">____</span> po. |<span id="total-best-time">____</span> min.',
...
const ko = {
    ...
    interruption2: '이 세션을 종료하시겠습니까? <br> 이것은 중단으로 간주되지 않습니다.',
    yes: '예',
    no: '아니요',
    ...
    bestDay: '최고의 날:',
    bestDayUnits: '<span id="total-best-pomo">____</span> 뽀. |<span id="total-best-time">____</span> 분.',
...
const es = {
    ...
    interruption2: '¿Finalizar esta sesión? <br> Esto no contará como una interrupción.',
    yes: 'Sí',
    no: 'No',
    ...
    avgInterruptionsUnits: '<span id = "total-interruptions"> ____ </span> por po.',
    bestDay: 'Mejor día:',
    bestDayUnits: '<span id = "total-best-pomo"> ____ </span> después. | <span id = "total-best-time"> ____ </span> min. ',
...
>>>
>>> > cc9cf939b5d7d4b6d20048fe207b539d9eeaecf0
/*
 * initial load
